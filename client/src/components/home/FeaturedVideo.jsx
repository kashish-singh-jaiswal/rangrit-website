  ...
  return (
    <section className="featured-video">
      <div className="container-custom">
        ...
        {/* Header Section */}
        <div className="video-header fade-up">
          <span className="section-subtitle">CINEMATIC WEDDING FILMS</span>
          <h2>
            Stories That Move Beyond <br /> Beautiful Photographs
          </h2>
        ...
        <div className="featured-video-grid">
          {films.map((film, index) => (
            <div 
              className="featured-film-card fade-up" 
              key={film.id}
            ...
            >
              ...
              <div className="film-card-content">
                <h3>{film.title}</h3>
                <span className="play-prompt">Watch Film</span>
              </div>
            </div>
          ))}
        </div>
        ...
        {/* View All Button */}
        <div className="video-btn-container fade-up" style={{ animationDelay: "0.6s" }}>
        ...
        {/* Instagram Section */}
        <div className="instagram-section fade-up" style={{ animationDelay: "0.8s" }}>
          <h2>Follow our journey</h2>
          <a
            href="https://www.instagram.com/rangritfilms/"
            target="_blank"
